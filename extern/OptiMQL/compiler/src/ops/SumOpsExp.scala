...
trait SumOpsExp extends SumOps with BaseFatExp with EffectExp {
  ...
  def optimql_sum[A:Manifest:Arith](start: Exp[Int], end: Exp[Int], block: Exp[Int] => Exp[A])(implicit cs: CanSum[A,A], ctx: SourceContext) = {
  ...
  def optimql_sumif[R:Manifest:Arith,A:Manifest](start: Exp[Int], end: Exp[Int], cond: Exp[Int] => Exp[Boolean], block: Exp[Int] => Exp[A])(implicit cs: CanSum[R,A], ctx: SourceContext) = {
