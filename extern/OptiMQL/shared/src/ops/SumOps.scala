...
trait SumOps extends CanSumOps {
  ...
  def sum[A:Manifest:Arith](start: Rep[Int], end: Rep[Int])(block: Rep[Int] => Rep[A])(implicit cs: CanSum[A,A], ctx: SourceContext) = optimql_sum(start, end, block)
  ...
  def sumRows[A:Manifest:Arith](start: Rep[Int], end: Rep[Int])(block: Rep[Int] => Rep[DenseVectorView[A]])(implicit cs: CanSum[A,A], ctx: SourceContext) = optimql_sumif[DenseVector[A],DenseVectorView[A]](start,end,i => unit(true),block)
  def sumIf[A:Manifest:Arith](start: Rep[Int], end: Rep[Int])(cond: Rep[Int] => Rep[Boolean])(block: Rep[Int] => Rep[A])(implicit cs: CanSum[A,A], ctx: SourceContext) = optimql_sumif[A,A](start,end,cond,block)
  def sumRowsIf[A:Manifest:Arith](start: Rep[Int], end: Rep[Int])(cond: Rep[Int] => Rep[Boolean])(block: Rep[Int] => Rep[DenseVectorView[A]])(implicit cs: CanSum[A,A], ctx: SourceContext) = optimql_sumif[DenseVector[A],DenseVectorView[A]](start,end,cond,block)
...
trait SumCompilerOps extends SumOps { this: OptiMQL => }
