...
trait TableMQLOps {
  ...
  def importTableOps() = {
    ...
    TableOps {
      ...
      //bulk reduce ops
      infix ("Sum") ("selector" -> (A ==> R) :: R, addTpePars = R withBound TArith) implements mapReduce((A,R), 0, ${$selector}, ${zeroType[R]}, ${(a,b) => a + b})

      //TODO: composite op
      infix ("Average") ("selector" -> (A ==> R) :: R, addTpePars = R withBound TArith) implements single ${
      ...
      infix ("OrderBy") ("sorts" -> varArgs((A,A) ==> MInt) :: Table(A)) implements composite ${
        // TODO: Tiark take a look here...
        // This code compile, but once used with Flare (delite-playground with optimql branch) on TPCH1
        // There is a stack overflow by recursivelly calling : val prev = buf(i-1)(a,b) generated by the code below.
        ...
        // buf += $sorts(0)
        // var i: Int = 1 // This is Int because it index a scala.collection.mutable.ArrayBuffer!
